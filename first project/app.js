var Shape = parseFloat(prompt("Welcome to the best shape simulation ever in the entire world!\n please select desired shape:\n 1)Square\n 2)Rectangle\n 3)Triangle"));
var length = 0;
var height = 0;
var signE = " * ";
var shapeContent = 0;
var tabIndicator = "&nbsp;&nbsp;";
var tabIndicator1 = "&nbsp;&nbsp;&nbsp ";
var newLineIndicator = "<br/>";
var enterLength = "Please enter {value} side length:";
var PleaseSelect = "please select shape content: \n 1)*****\n 2) *     *\n 3) 12345\n 4) 54321";
var Error1 = "Error.please select 1 or 2 or 3 or 4";
var Error2 = "Error.please enter a positive integer number.";
function DrawShape(sign, indicator) {
...
if (Shape <= 0 || Shape >= 4) {
    ...
    if (Shape == 1) {
        var length = parseFloat(prompt(enterLength.replace("{value}", "square")));
...
if (Shape == 3) {
    var length = parseFloat(prompt(enterLength.replace("{value}", "Triangle")));
